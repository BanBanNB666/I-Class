<template>
    <button type="button" class="btn btn-default btn-circle"><i class="bi bi-arrow-right"></i></button>
    ...
    <h2>lg</h2>
    <button type="button" class="btn btn-default btn-circle btn-lg"><i class="bi bi-arrow-right"></i></button>
