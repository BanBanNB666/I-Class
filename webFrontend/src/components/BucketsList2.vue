<template>
    <el-row style="" class="tac">
        <el-col :span="24">
            <el-menu default-active="2" class="el-menu-vertical-demo">
                <el-menu-item  v-for="bucket in data" @click="emitBucket(bucket.bucketName)" style="padding-left: 25%;" >
                    <i class="bi bi-database" style="font-size: medium;"></i>
                    <span slot="title"  style="font-size: medium;"> {{ bucket.bucketName }}</span>
                </el-menu-item>
            </el-menu>
        </el-col>
    </el-row>
